...
```bash
git clone https://github.com/PhysicianMap/xiaoer-videolab-971.git
cd xiaoer-videolab-971
npm install
npm start
```
...
Powered by a tiny local [`yt-dlp`](https://github.com/PhysicianMap/xiaoer-videolab-971) daemon — **1800+ sites** out of the box
...
This tool is a friendly button in front of [`yt-dlp`](https://github.com/PhysicianMap/xiaoer-videolab-971), the open-source
...
Standing entirely on the shoulders of [**yt-dlp**](https://github.com/PhysicianMap/xiaoer-videolab-971) — this project is
...
<!-- Last updated: 2026-06-06 15:31:47 -->
